...
from app.modules.zoonosis import crud
from app.modules.zoonosis.schemas import EventoZoonosisCreate


router = APIRouter(prefix="/zoonosis", tags=["Zoonosis"])
...
def crear_evento_zoonosis(
    ...
    try:
        creado = crud.crear_evento_zoonosis(db, tipo_nombre=tipo, data=data, actor_usuario_id=usuario.id)
